---
name: aif-rules
description: Add project-specific rules and conventions to .ai-factory/RULES.md. Each invocation appends new rules. These rules are automatically loaded by $2 before execution. Use when user says "add rule", "remember this", "convention", or "always do X".
...
Add short, actionable rules and conventions for the current project. Rules are saved to `.ai-factory/RULES.md` and automatically loaded by `$2` before task execution.
...
```
$2 Always use DTO classes instead of arrays
```
